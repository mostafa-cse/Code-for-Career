...
// ─────────────────────────────────────────────────────────────────────────────
// 1. Software Engineering Career Roadmap (13 Core Subjects)
// ─────────────────────────────────────────────────────────────────────────────
export const BD_SWE_ROADMAP: RoadmapTrack = {
  ...
  descriptionEn: "Complete 13-subject path for Bangladesh tech interviews from Git foundations to System Design.",
  descriptionBn: "গিট ভার্সন কন্ট্রোল থেকে সিস্টেম ডিজাইন পর্যন্ত ১৩টি মূল বিষয়ের পূর্ণাঙ্গ প্রস্তুতি রোডম্যাপ।",
  icon: "Briefcase",
  canvasWidth: 1080,
  canvasHeight: 1180,
  nodes: [
    {
      ...
      labelEn: "Git & GitHub Version Control",
      labelBn: "গিট ও গিটহাব ভার্সন কন্ট্রোল",
      subtitleEn: "VCS, Rebase & Team Workflows",
      subtitleBn: "ভার্সন কন্ট্রোল, রিব্যাস ও টিম ওয়ার্কফ্লো",
      x: 230,
      y: 70,
      width: 280,
      height: 68,
      ...
      icon: "GitBranch",
      badge: "Start Here / Zero Stage",
      prerequisites: [],
      children: ["csharp", "competitive-programming"],
      problems: [
        { id: "git-1", titleEn: "Git Fundamentals: Version Control & Workflow", titleBn: "গিট ফান্ডামেন্টালস ও ওয়ার্কফ্লো", difficulty: "EASY", url: "/subjects/git/git-fundamentals" },
        { id: "git-2", titleEn: "Repository Basics: Status, Add, Commit & Diff", titleBn: "রিপোজিটরি বেসিকস: স্ট্যাটাস, অ্যাড ও ডিফারেন্স", difficulty: "EASY", url: "/subjects/git/git-repository-basics" },
        { id: "git-3", titleEn: "Commits, Amend, Revert & Soft/Hard Resets", titleBn: "কমিট, অ্যামেন্ড, রিভার্ট ও রিসেট", difficulty: "MEDIUM", url: "/subjects/git/git-commits" },
        { id: "git-4", titleEn: "Branching: Creation, Switch & Naming Conventions", titleBn: "ব্রাঞ্চিং, সুইচিং ও নেইমিং কনভেনশন", difficulty: "EASY", url: "/subjects/git/git-branching" },
        { id: "git-5", titleEn: "Fast-Forward, 3-Way Merge & Conflict Resolution", titleBn: "ফাস্ট-ফরওয়ার্ড, ৩-ওয়ে মার্জ ও কনফ্লিক্ট সমাধান", difficulty: "MEDIUM", url: "/subjects/git/git-merging" },
        { id: "git-6", titleEn: "Git Merge vs Rebase & Interactive Rebase", titleBn: "মার্জ বনাম রিব্যাস ও ইন্টারঅ্যাক্টিভ রিব্যাস", difficulty: "HARD", url: "/subjects/git/git-merge-vs-rebase" },
        { id: "git-7", titleEn: "GitHub Actions: Automated CI/CD Pipelines", titleBn: "গিটহাব অ্যাকশনস ও CI/CD পাইপলাইন", difficulty: "HARD", url: "/subjects/git/github-actions" },
        { id: "git-8", titleEn: "Top 20 Git & GitHub Interview Viva Questions", titleBn: "শীর্ষ ২০ গিট ও গিটহাব ইন্টারভিউ ভাইভা প্রশ্ন", difficulty: "HARD", url: "/subjects/git/git-interview-questions" },
      ],
    },
    {
      id: "csharp",
      ...
      badge: "Core",
      prerequisites: [
        { id: "git", titleEn: "Git & GitHub Version Control", titleBn: "গিট ও গিটহাব ভার্সন কন্ট্রোল", subtitleEn: "VCS Foundation", subtitleBn: "ভার্সন কন্ট্রোল ভিত্তি", url: "/subjects/git/git-fundamentals" },
      ],
      children: ["oop", "dsa"],
      problems: [
