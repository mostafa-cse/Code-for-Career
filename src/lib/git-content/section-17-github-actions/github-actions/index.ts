...
> **Security - Automatic Log Masking:** If a script prints a secret to the terminal, GitHub automatically scrubs it and replaces it with \`***\` in the build logs!
...
> **সিকিউরিটি - লগ মাস্কিং (Automatic Masking):** স্ক্রিপ্ট চলার সময় যদি দুর্ঘটনাবশত কোনো সিক্রেট টার্মিনালে প্রিন্টও হয়ে যায়, গিটহাব নিজে থেকেই তা ব্লার করে \`***\` দেখায়, যাতে অন্য কেউ দেখতে না পারে!
