    ...
    <div className="flex min-h-[calc(100vh-8rem)] items-center justify-center px-4">
      <div className="w-full max-w-sm">
        ...
        <div className="mb-8 flex flex-col items-center gap-3 text-center">
          ...
          <div>
            <h1 className="text-xl font-extrabold text-foreground">
              {t(`Sign in to ${SITE_NAME}`, `${SITE_NAME} এ প্রবেশ করুন`)}
            </h1>
          ...
          {view === "magic-link-sent" ? (
            ...
            <form onSubmit={handleMagicLink} className="flex flex-col gap-4">
              <div>
                ...
                <input
                  ...
                  placeholder={t("you@example.com", "আপনার@ইমেইল.com")}
              ...
              <button
                type="submit"
                disabled={loading}
                className="flex w-full items-center justify-center gap-2 rounded-lg bg-foreground px-4 py-2.5 text-sm font-semibold text-background shadow-xs transition-opacity hover:opacity-90 disabled:opacity-60"
              >
                {loading ? (
            ...
            <div className="flex flex-col gap-3">
              ...
              >
                ...
                {t("Continue with Google", "Google দিয়ে প্রবেশ করুন")}
              </button>
              ...
              >
                ...
                {t("Continue with GitHub", "GitHub দিয়ে প্রবেশ করুন")}
              </button>
              ...
              >
                <Mail className="h-4 w-4" />
                {t("Continue with Email", "ইমেইল দিয়ে প্রবেশ করুন")}
              </button>
        ...
        <p className="mt-5 text-center text-xs text-muted-foreground">
          {t(
            "By signing in you agree to our terms. Progress is saved to your account.",
            "সাইন ইন করে আপনি আমাদের শর্তে সম্মত হচ্ছেন। অগ্রগতি আপনার অ্যাকাউন্টে সংরক্ষিত হবে।"
          )}
        </p>
      </div>
    </div>
